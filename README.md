...
For our purposes, DEX is short for Decentralized Exchange. See [DEX Terminal](https://dexterminal.com/) to see activity on decentralized exchange protocols.
...
| [Blocknet](https://www.blocknet.co/) | Bitcoin based currencies, Etheruem| Blocknet | Live | Open protocol. The Block DX DEX is built on top of the open source Blocknet protocol utilising cros-chain atomic swaps and XRouter technology to interact with any blockchain. |
